...
This will generate https://raw.githubusercontent.com/indigoviolet/dotfiles-yadm/HEAD/.config/yadm/start.sh, which can be run like

#+begin_src shell
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/indigoviolet/dotfiles-yadm/HEAD/.config/yadm/start.sh)"
#+end_src

...
/home/venky/.asdf/installs/poetry/1.2.0a2/bin
...
Failing command: ['/home/venky/.asdf/installs/poetry/1.2.0a2/venv/bin/python3', '-Im', 'ensurepip', '--upgrade', '--default-pip']


Cleanup: Something went wrong!

49 /home/venky/.asdf/plugins/poetry/bin/install: POETRY_HOME=$install_path python3 - --version "$version" $flags
Error: bootstrap '/home/venky/.config/yadm/bootstrap.d/030-asdf.sh' failed
...
.ssh/id_rsa* filter=crypt diff=crypt merge=crypt
#+end_src
...
sudo apt-get install --no-install-recommends -y zsh && sudo chsh -s /usr/bin/zsh
#+end_src

...
** Use https://github.com/casey/just to collect all executable commands global and project-specific?
...
#+RESULTS:
: Bus 001 Device 022: ID 1ea7:0064 SHARKOON Technologies GmbH 2.4GHz Wireless rechargeable vertical mouse [More&Better]
: Bus 001 Device 021: ID 05f3:0007 PI Engineering, Inc. Kinesis Advantage PRO MPC/USB Keyboard
: Bus 001 Device 015: ID 043e:9a39 LG Electronics USA, Inc. LG Monitor Controls
...
#+RESULTS:
#+begin_example
/sys/bus/usb/devices/1-3.2.2.2/power/wakeup:enabled
--
/sys/bus/usb/devices/1-3.2.2/product:Kinesis Keyboard Hub
/sys/bus/usb/devices/1-3.2.3/product:2.4G Mouse
/sys/bus/usb/devices/1-3.2/product:4-Port USB 2.0 Hub

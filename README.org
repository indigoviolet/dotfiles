...
- j2cli (pipx) https://github.com/kolypto/j2cli for templating
- netstat from apt net-tools
...
#+begin_src shell :shebang "#!/bin/zsh" :tangle ~/.config/yadm/bootstrap.d/070-misc-utilities.zsh##distro.Ubuntu,e.zsh
set -eux
